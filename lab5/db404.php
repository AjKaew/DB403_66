...
<?php
  $sql = 'SELECT ContactName, ContactTitle, Country FROM customers WHERE ContactTitle = "Owner" AND Country IN
  ("Mexico" , "Spain" , "France");';
  $result = $conn->query($sql);
  while ($row = $result->fetch_assoc()) {
    echo "<tr>
...
?>
    ...
    <li>
      ...
      <div>
        <code>
        SELECT CompanyName, ContactTitle, Country FROM customers WHERE ContactTitle = "Owner" AND
Country IN ("Mexico" , "Spain" , "France") ORDER BY CompanyName DESC LIMIT 2;
        </code>
        <br>
        <table>
          <tr>
...
<?php
  $sql = 'SELECT CompanyName, ContactTitle, Country FROM customers WHERE ContactTitle = "Owner" AND
  Country IN ("Mexico" , "Spain" , "France") ORDER BY CompanyName DESC LIMIT 2;';
  $result = $conn->query($sql);
  while ($row = $result->fetch_assoc()) {
    echo "<tr>
...
<?php
  $sql = 'SELECT ProductName, UnitPrice, QuantityPerUnit FROM products WHERE QuantityPerUnit LIKE "%Box%" ORDER
  BY UnitPrice DESC LIMIT 5;';
  $result = $conn->query($sql);
  while ($row = $result->fetch_assoc()) {
    echo "<tr>
...
?>
    ...
    <li>
      ...
      <div>
        <code>
        SELECT Country, COUNT(*) AS Member FROM customers WHERE Country IN ("UK", "France", "Spain") GROUP BY
Country;
        </code>
        <br>
        <table>
...
<?php
  $sql = 'SELECT Country, COUNT(*) AS Member FROM customers WHERE Country IN ("UK", "France", "Spain") GROUP BY
  Country;';
  $result = $conn->query($sql);
  while ($row = $result->fetch_assoc()) {
    echo "<tr>
...
?>
    ...
    <li>
      ...
      <div>
        <code>
        SELECT Country, COUNT(*) AS Member FROM customers WHERE Country IN ("UK", "France", "Spain") GROUP BY
Country HAVING member > 5 ORDER BY 2;
        </code>
        <br>
        <table>
          <tr>
